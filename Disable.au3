...
Global $iReply = msgbox(308, "Active Directory Functions", "This script disables the specified object (user account, computer account)." & @CRLF & @CRLF & _
...
GUICtrlCreateLabel("Object to disable (FQDN or sAMACccountName):", 8, 10, 231, 34)
Global $IObject = GUICtrlCreateInput("", 241, 10, 459, 21)
Global $BOK = GUICtrlCreateButton("Disable object", 8, 72, 121, 33)
...
; 改变对象
Global $iValue = _AD_DisableObject($sObject)
If $iValue = 1 Then
